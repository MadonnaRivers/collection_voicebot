...
# max_connections=200 supports 50+ concurrent calls each doing TTS + webhooks simultaneously.
# pool timeout raised to 10s so webhook/audio uploads during call-end bursts don't drop.
http = httpx.AsyncClient(
    timeout=httpx.Timeout(connect=2.0, read=15.0, write=5.0, pool=10.0),
